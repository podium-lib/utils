...
const { uriIsRelative, pathnameBuilder, uriIsSchemaLess } = require('./utils');
...
const PodiumAssetJs = class PodiumAssetJs {
    ...
    get value() {
        ...
        return uriIsRelative(value) && !uriIsSchemaLess(value) ? pathnameBuilder(pathname, value) : value;
    }
