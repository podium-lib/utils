...
export default class HttpIncoming {
    ...
    /**
     * @type {Array<import('./asset-css.js').default | string>}
     */
    #css;

    /**
     * @type {Array<import('./asset-js.js').default | string>}
     */
    #js;
    ...
    /**
     * @returns {Omit<PodiumHttpIncoming<T>, 'css' | 'js'> & { css: Array<string | import('./asset-css.js').CssAsset>; js: Array<string | import('./asset-js.js').JavaScriptAsset> }}
     */
    toJSON() {
        return {
