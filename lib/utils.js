...
export const uriBuilder = uriBuilder;

// module.exports.uriIsRelative = uriIsRelative;
export const uriIsRelative = uriIsRelative;

// module.exports.pathnameBuilder = pathnameBuilder;
export const pathnameBuilder = pathnameBuilder;

// module.exports.uriRelativeToAbsolute = uriRelativeToAbsolute;
export const uriRelativeToAbsolute = uriRelativeToAbsolute;

// module.exports.setAtLocalsPodium = setAtLocalsPodium;
export const setAtLocalsPodium = setAtLocalsPodium;

// module.exports.getFromLocalsPodium = getFromLocalsPodium;
export const getFromLocalsPodium = getFromLocalsPodium;

// module.exports.duplicateOnLocalsPodium = duplicateOnLocalsPodium;
export const duplicateOnLocalsPodium = duplicateOnLocalsPodium;

// module.exports.serializeContext = serializeContext;
export const serializeContext = serializeContext;

// module.exports.deserializeContext = deserializeContext;
export const deserializeContext = deserializeContext;
*/