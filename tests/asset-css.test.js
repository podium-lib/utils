...
tap.test(
    'Css() - no arguments given - should construct object with default values',
    (t) => {
        const obj = new AssetCss({ value: '/foo' });
...
tap.test(
    'Css() - no arguments given - should construct JSON with default values',
    (t) => {
        const obj = new AssetCss({ value: '/foo' });
...
tap.test(
    'Css() - pathname is given - prefix is unset - should NOT append pathname to "value"',
    (t) => {
...
tap.test(
    'Css() - pathname is given - prefix is false - should NOT append pathname to "value"',
    (t) => {
...
tap.test(
    'Css() - pathname is given - prefix is true - should append pathname to "value"',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            pathname: '/bar',
...
tap.test(
    'Css() - pathname is given - prefix is unset - should NOT append pathname to "value" for toJSON()',
    (t) => {
        const obj = new AssetCss({ value: '/foo', pathname: '/bar' });
        const json = JSON.parse(JSON.stringify(obj));
        t.same(json, {
...
tap.test(
    'Css() - pathname is given - prefix is false - should NOT append pathname to "value" for toJSON()',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            pathname: '/bar',
...
tap.test(
    'Css() - pathname is given - prefix is true - should NOT append pathname to "value" for toJSON()',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            pathname: '/bar',
...
tap.test(
    'Css() - pathname is given - prefix is unset - should NOT append pathname to "href" for toHTML()',
    (t) => {
        const obj = new AssetCss({ value: '/foo', pathname: '/bar' });
        t.equal(
            obj.toHTML(),
...
tap.test(
    'Css() - pathname is given - prefix is false - should NOT append pathname to "href" for toHTML()',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            pathname: '/bar',
...
tap.test(
    'Css() - pathname is given - prefix is true - should append pathname to "href" for toHTML()',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            pathname: '/bar',
...
tap.test(
    'Css() - value if absoulte - pathname is given - prefix is true - should NOT append pathname to "value"',
    (t) => {
        const obj = new AssetCss({
...
tap.test(
    'Css() - set "crossorigin" - should construct object as expected',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
        });
...
tap.test(
    'Css() - set "disabled" - should construct object as expected',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
        });
...
tap.test(
    'Css() - set "hreflang" - should construct object as expected',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
        });
...
tap.test('Css() - set "type" - should construct object as expected', (t) => {
    ...
    t.equal(obj.toHTML(), '<link href="/foo" type="bar" rel="stylesheet">');
...
tap.test('Css() - set "rel" - should construct object as expected', (t) => {
    ...
    t.equal(obj.rel, 'bar');
    t.equal(obj.toHTML(), '<link href="/foo" type="text/css" rel="bar">');
