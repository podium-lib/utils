...
tap.test(
    '.buildLinkElement() - "value" property has a value - should appended "href" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
        });
        const result = utils.buildLinkElement(obj);
        t.equal(result, '<link href="/foo" type="text/css" rel="stylesheet">');
        t.end();
    },
);

tap.test(
    '.buildLinkElement() - "crossorigin" property has a value - should appended "crossorigin" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            crossorigin: 'bar',
...
tap.test(
    '.buildLinkElement() - "hreflang" property has a value - should appended "hreflang" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            hreflang: 'bar',
...
tap.test(
    '.buildLinkElement() - "title" property has a value - should appended "title" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            title: 'bar',
...
tap.test(
    '.buildLinkElement() - "media" property has a value - should appended "media" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            media: 'bar',
...
tap.test(
    '.buildLinkElement() - "as" property has a value - should appended "as" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            as: 'bar',
...
tap.test(
    '.buildLinkElement() - "type" property has a value - should appended "type" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            type: 'bar',
...
tap.test(
    '.buildLinkElement() - "rel" property has a value - should appended "rel" attribute to element',
    (t) => {
        const obj = new AssetCss({
            value: '/foo',
            rel: 'bar',
...
tap.test(
    '.buildLinkElement() - properties are "undefined" - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetCss({
...
tap.test(
    '.buildLinkElement() - properties are "false" - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetCss({
            crossorigin: false,
            disabled: false,
...
tap.test(
    '.buildLinkElement() - properties are empty string - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetCss({
            crossorigin: '',
            // @ts-ignore Testing bad input
...
tap.test('.buildLinkElement() - crossorigin boolean false', (t) => {
    ...
    const result = utils.buildLinkElement(obj);
    t.equal(result, `<link href="/bar" type="text/css" rel="stylesheet">`);
    t.end();
});
...
tap.test(
    '.buildScriptElement() - "value" property has a value - should appended "src" attribute to element',
    (t) => {
...
tap.test(
    '.buildScriptElement() - "type" property has "module" as value - should appended "type" attribute with "module" as value to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            type: 'module',
...
tap.test(
    '.buildScriptElement() - "type" property has "esm" as value - should appended "type" attribute with "module" as value to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            type: 'esm',
...
tap.test(
    '.buildScriptElement() - "type" property has "cjs" as value - should NOT appended a attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            type: 'cjs',
...
tap.test(
    '.buildScriptElement() - "referrerpolicy" property has a value - should appended "referrerpolicy" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            referrerpolicy: 'bar',
...
tap.test(
    '.buildScriptElement() - "crossorigin" property has a value - should appended "crossorigin" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            crossorigin: 'bar',
...
tap.test(
    '.buildScriptElement() - "integrity" property has a value - should appended "integrity" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            integrity: 'bar',
...
tap.test(
    '.buildScriptElement() - "nomodule" property is "true" - should appended "nomodule" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            nomodule: true,
...
tap.test(
    '.buildScriptElement() - "async" property is "true" - should appended "async" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            async: true,
...
tap.test(
    '.buildScriptElement() - "data" property has a value - should appended "data" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            data: [
...
tap.test(
    '.buildScriptElement() - "defer" property is "true" - should appended "defer" attribute to element',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            defer: true,
...
tap.test(
    '.buildScriptElement() - properties are "undefined" - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetJs({
...
tap.test(
    '.buildScriptElement() - properties are "false" - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetJs({
            // @ts-ignore Testing bad input
...
tap.test(
    '.buildScriptElement() - properties are empty string - should NOT appended attributes to element',
    (t) => {
        const obj = new AssetJs({
            referrerpolicy: '',
            integrity: '',
...
tap.test('.buildScriptAttributes() - basic', (t) => {
    ...
    t.same(utils.buildScriptAttributes(obj), [{ key: 'src', value: '/bar' }]);
    t.end();
});

tap.test(
    '.buildScriptElement() - strategy lazy - builds HTML with dynamic import',
    (t) => {
        const obj = new AssetJs({
            value: '/foo',
            type: 'module',
...
tap.test(
    '.buildScriptElement() - strategy lazy - automatically includes type="module" if not provided',
    (t) => {
